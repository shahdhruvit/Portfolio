...
const TimelineItem = (items:any) => {
    ...
    return items.map((item:any, index:number) => <Timeline.Item data-aos="fade-up" data-aos-duration="800" className="!pt-12 !mb-2 sm-mx:!p-1" key={index} bullet={<IconBriefcaseFilled className="!text-bgColor" size={size} />} >
...
const Experience = () => {
    ...
    return <div className="px-16 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Experience">
        <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl font-bold mb-10 text-center text-white">
            <span className="text-primaryColor">04.&nbsp;</span>Experience</h1>
